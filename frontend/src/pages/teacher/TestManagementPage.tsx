    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-700 flex items-center justify-center text-white shadow-md flex-shrink-0">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 mb-6">
          <div className="relative sm:col-span-2 lg:col-span-1">
            ...
            <input
              ...
              className="w-full border border-slate-300 rounded-lg pl-9 pr-3 py-2 text-xs bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 font-medium"
            />
          </div>
          ...
          <select
            ...
            className="border border-slate-300 rounded-lg px-3 py-2 text-xs bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 font-semibold text-slate-700"
          >
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            icon={<FileText className="w-8 h-8 text-indigo-500 stroke-[1.5]" />}
                ...
                >
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 pb-3 border-b border-slate-100">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-xl bg-indigo-50 border border-indigo-200 flex items-center justify-center font-bold text-indigo-700 text-xs flex-shrink-0">
            ...
            <form onSubmit={handleSaveTest} className="py-4 space-y-4 text-xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border border-slate-300 rounded-lg p-2 bg-white font-semibold text-slate-800 focus:ring-2 focus:ring-indigo-500"
                    >
                      {classes.map((c) => (
                        <option key={c.id} value={c.id}>
                          {c.name}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-slate-300 rounded-lg p-2.5 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-indigo-500 font-semibold text-slate-800"
                  />
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-slate-300 rounded-lg p-2.5 bg-white focus:ring-2 focus:ring-indigo-500 font-bold text-slate-900"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-slate-300 rounded-lg p-2 bg-white focus:ring-2 focus:ring-indigo-500 font-semibold"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-slate-300 rounded-lg p-2 bg-white focus:ring-2 focus:ring-indigo-500 font-bold"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-slate-300 rounded-lg p-2 bg-white focus:ring-2 focus:ring-indigo-500 text-xs"
                  />
                </div>
              </div>
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-3">
                ...
                {uploadedPaperUrl ? (
                  <div className="p-3 bg-white rounded-xl border border-emerald-200 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-2 py-1 text-xs font-semibold text-indigo-600 hover:text-indigo-800 bg-indigo-50 rounded-md"
                      >
                        Preview
                      </button>
                      <button
                  ...
                  >
                    <UploadCloud className="w-8 h-8 mx-auto mb-1 text-indigo-600" />
            ...
            <div className="py-4 space-y-4 text-xs">
              ...
              <form onSubmit={handleAddCustomType} className="flex gap-2">
                <input
                  ...
                  className="flex-1 border border-slate-300 rounded-lg px-3 py-2 text-xs bg-slate-50 focus:bg-white focus:ring-2 focus:ring-indigo-500 font-semibold"
                />
                <Button
                  type="submit"
                  size="sm"
