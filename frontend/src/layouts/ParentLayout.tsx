...
export const ParentLayout: React.FC = () => {
  ...
  // 🏠 Home, 📅 Attendance, 📊 Results, 🔔 Updates, 👤 Profile
  const bottomNavItems = [
    { name: 'Home', href: '/parent', icon: Home },
    { name: 'Attendance', href: '/parent/attendance', icon: Calendar },
    { name: 'Results', href: '/parent/marks', icon: BarChart3 },
    { name: 'Updates', href: '/parent/daily-updates', icon: Bell },
          ...
          <div className="bg-white rounded-[20px] border border-slate-200 shadow-xl max-w-xs w-full p-5 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-sm text-slate-900">Recent Updates</h3>
              </div>
              <button
            ...
            <div className="space-y-2 text-xs">
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 flex items-start gap-2">
                ...
                <div>
                  <div className="font-bold text-slate-800">Physics Mock Test Published</div>
              ...
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 flex items-start gap-2">
                ...
                <div>
                  <div className="font-bold text-slate-800">Attendance Marked: Present</div>
                  <div className="text-[11px] text-slate-500">Today, 08:30 AM</div>
                </div>
              </div>
            </div>
            <button
