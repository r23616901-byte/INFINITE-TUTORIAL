...
export const AdminLayout: React.FC = () => {
  ...
  // 🏠 Home, 🏫 Academy, 👥 Users, 📊 Reports, 👤 Profile
  const bottomNavItems = [
    { name: 'Home', href: '/admin', icon: Home },
    { name: 'Academy', href: '/admin/batches', icon: Building2 },
    { name: 'Users', href: '/admin/students', icon: Users },
    { name: 'Reports', href: '/admin/audit-logs', icon: BarChart3 },
    { name: 'Profile', href: '/admin/settings-security', icon: ShieldCheck },
  ];
              ...
              >
                <div
                  className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all ${
                    isActive ? 'bg-amber-50 text-amber-600 shadow-xs' : 'text-slate-500'
                  }`}
                >
          ...
          <div className="bg-white rounded-[20px] border border-slate-200 shadow-xl max-w-xs w-full p-5 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-sm text-slate-900">Admin Alerts</h3>
              </div>
              <button
            ...
            <div className="space-y-2 text-xs">
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 flex items-start gap-2">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-500">Today, 03:00 AM</div>
                </div>
              </div>
            </div>
            <button
